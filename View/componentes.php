...
<html>
    <head>
        <title>Gaming and Computers</title>
    ...
    <body>
        ...
        <?php
            ...
            $resultado = $conexion->cargarTabla("select Nombre, Descripcion, Precio, Cantidad, Imagen from componentes");
            ...
            echo "<img style= 'width: 30%' src= '$ImagenFinal'>";
